    ...
    >
      ...
      <div
        ...
        >
          ...
          <h2 className="text-center mb-2 font-semibold">
            Lunar Beauty Parlour and spa
          </h2>
          <p className="text-center">
            This a marketing webite I made for a beauty shop called Lunar Beauty
            Parlour and spa. It was created using react and the animation done
            using framer motion.
          </p>
          <div className="w-[100%] flex justify-around mt-3">
            <button
        ...
        >
          ...
          <p className="text-center">
            ...
            Techware Enterprises Ltd. They deal in computer devices and
            surveillance equipment. The site is created using wordpress and the
